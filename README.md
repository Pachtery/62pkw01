...
5. ทำการติดตั้งนัมพาย
 ```bash
  pip install numpy
 ```
ซึ่งจาก 5 ขั้นตอนเป็นการเสร็จสิ้นการติดตั้งโอเพนซีวี 4.3.0 ดังนั้นในการใช้งานของโครงงานนี้สามารถใช้ภาษาไพทอนเขียนและใช้ไลบรารีโอเพนซีวีในการจดจำใบหน้าและท่าทางมือมาช่วยในการควบคุมการเปิดและปิดไฟภายในบ้านได้
----------
